...
map_data <- readRDS(here("shiny_app", "data", "processed", "shiny_data.rds"))
full_taxa <- readRDS(here("shiny_app", "data", "processed", "full_taxa.rds"))

# Count number of unique species for summary ----
# Full dataset:
total_detections <- full_taxa |> 
...
# Indicators
n_unique_indicators <- n_distinct(map_data$map_label)
